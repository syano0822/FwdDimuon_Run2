...
void runAnalysisQA(string runPeriod = "LHC16k",
		   ...
		   bool isMix        = false)
{
  ...
  if(isEventSelection){
    offlineTriggerMask = AliVEvent::kINT7inMUON | AliVEvent::kMuonSingleLowPt7 | AliVEvent::kMuonUnlikeLowPt7 | AliVEvent::kMuonLikeLowPt7;
    //offlineTriggerMask = AliVEvent::kINT7inMUON;
  } else {
  ...
  string period = "LHC18d";runPeriod;
  ...
  AliAnalysisTaskAODEventStudy *task
    = reinterpret_cast<AliAnalysisTaskAODEventStudy*>(gInterpreter->ExecuteMacro(Form("AddTaskAODEventQA.C(%u, %f, %f, %d, %f, %f, \"%s\", \"%s\", %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d,%d,%f,%d)",
										     offlineTriggerMask,
										      min_vtxz,
										     max_vtxz,
										     min_vtx_cont,
  ...
  AliAnalysisTaskAODEventStudy* task = AddTaskAODEventQA(offlineTriggerMask,
							  min_vtxz,
							  max_vtxz,
							  min_vtx_cont,
							  min_pair_rap,
...
AliAnalysisGrid* CreateAlienHandler(string runPeriod, string run_mode, Bool_t isJDL, string type, bool onMixingAnalysis){
  ...
  if (onMixingAnalysis) {
    plugin->SetGridWorkingDir(Form("PWGLF/AOD/%s/LowMassDimuonMix/%s",runPeriod.c_str(),type.c_str()));
  } else {
    plugin->SetGridWorkingDir(Form("PWGLF/AOD/%s/LowMassDimuon/%s",runPeriod.c_str(),type.c_str()));
  }
  ...
  //runPeriod 
  if(type == "OfficialLMR"){
    if (runPeriod.find("18") != std::string::npos){
      plugin->SetGridDataDir("/alice/sim/2020/LHC20f10a");    
    } else if (runPeriod.find("17") != std::string::npos){
      plugin->SetGridDataDir("/alice/sim/2020/LHC20f10b");    
    } else if (runPeriod.find("16") != std::string::npos){
      plugin->SetGridDataDir("/alice/sim/2020/LHC20f10c");    
    } 
    plugin->SetDataPattern("/AOD/ AliAOD.Muons.root");
  } else if(type == "GeneralPurposeMC"){
    if(runPeriod == "LHC16h"){
      plugin->SetGridDataDir("/alice/sim/2017/LHC17f5");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC16i"){
      plugin->SetGridDataDir("/alice/sim/2017/LHC17d3");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC16j"){
      plugin->SetGridDataDir("/alice/sim/2017/LHC17e5");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC16k"){
      plugin->SetGridDataDir("/alice/sim/2018/LHC18f1");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC16l"){
      plugin->SetGridDataDir("/alice/sim/2018/LHC18d8");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC16o"){
      plugin->SetGridDataDir("/alice/sim/2017/LHC17d16");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC16p"){
      plugin->SetGridDataDir("/alice/sim/2017/LHC17d18");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC17h"){
      plugin->SetGridDataDir("/alice/sim/2018/LHC18c12");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC17i"){
      plugin->SetGridDataDir("/alice/sim/2017/LHC17k4");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC17k"){
      plugin->SetGridDataDir("/alice/sim/2018/LHC18c13");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC17l"){
      plugin->SetGridDataDir("/alice/sim/2018/LHC18a8");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC17m"){
      plugin->SetGridDataDir("/alice/sim/2017/LHC17l5");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC17o"){
      plugin->SetGridDataDir("/alice/sim/2018/LHC18a9");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC17r"){
      plugin->SetGridDataDir("/alice/sim/2018/LHC18a1");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
      ...
      plugin->SetGridDataDir("/alice/sim/2018/LHC18g5");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC18e"){
      plugin->SetGridDataDir("/alice/sim/2018/LHC18g6");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC18f"){
      plugin->SetGridDataDir("/alice/sim/2018/LHC18h2");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC18l"){
      plugin->SetGridDataDir("/alice/sim/2018/LHC18j1");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC18m"){
      plugin->SetGridDataDir("/alice/sim/2018/LHC18j4");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC18o"){
      plugin->SetGridDataDir("/alice/sim/2018/LHC18k2");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    } else if(runPeriod == "LHC18p"){
      plugin->SetGridDataDir("/alice/sim/2018/LHC18k3");
      plugin->SetDataPattern("/AOD235/ AliAOD.root");
    }
    ...
    if(runPeriod.find("16") != std::string::npos){
      ...
      plugin->SetDataPattern("AliAOD.root");
    } else if(runPeriod.find("18") != std::string::npos){
    ...
    } else if (runPeriod.find("LHC16l") != std::string::npos){
      plugin->SetGridDataDir("/alice/data/2016/LHC16l");
      plugin->SetDataPattern("/pass3/AOD/ AliAOD.root");
    } else if (runPeriod.find("LHC16o") != std::string::npos){
      plugin->SetGridDataDir("/alice/data/2016/LHC16o");
      plugin->SetDataPattern("/pass2/AOD/ AliAOD.root");
    } else if (runPeriod.find("LHC16p") != std::string::npos){
      plugin->SetGridDataDir("/alice/data/2016/LHC16p");
      plugin->SetDataPattern("/pass2/AOD/ AliAOD.root");
    } else if (runPeriod.find("LHC17h") != std::string::npos){
  ...
  if(runPeriod.find("LHC16j") != std::string::npos){
  ...
  if(runPeriod.find("LHC16l") != std::string::npos){
    ...
    plugin->AddRunNumber(259118); plugin->AddRunNumber(259162); plugin->AddRunNumber(259164); plugin->AddRunNumber(259204); plugin->AddRunNumber(259257);  
    ...
    plugin->AddRunNumber(259340); plugin->AddRunNumber(259341); plugin->AddRunNumber(259342); plugin->AddRunNumber(259378); plugin->AddRunNumber(259379);  
    ...
    plugin->AddRunNumber(259469); plugin->AddRunNumber(259471); plugin->AddRunNumber(259477); plugin->AddRunNumber(259649); plugin->AddRunNumber(259650);  
    ...
    plugin->AddRunNumber(259888); plugin->AddRunNumber(259954); plugin->AddRunNumber(259961); plugin->AddRunNumber(259979); plugin->AddRunNumber(260010);  
    plugin->AddRunNumber(260011); plugin->AddRunNumber(260014);

  }

  if(runPeriod.find("LHC16k") != std::string::npos){
    /*
  ...
  if(runPeriod.find("LHC16o") != std::string::npos){
  ...
  if(runPeriod.find("LHC16p") != std::string::npos){
  ...
  if(runPeriod.find("LHC17h") != std::string::npos){
  ...
  if(runPeriod.find("LHC17i") != std::string::npos){
  ...
  if(runPeriod.find("LHC17k") != std::string::npos){
  ...
  if(runPeriod.find("LHC17l") != std::string::npos){
  ...
  if(runPeriod.find("LHC17m") != std::string::npos){
  ...
  if(runPeriod.find("LHC17o") != std::string::npos){
  ...
  if(runPeriod.find("LHC17r") != std::string::npos){
  ...
  if(runPeriod.find("LHC18c") != std::string::npos){
  ...
  if(runPeriod.find("LHC18d") != std::string::npos){
  ...
  if(runPeriod.find("LHC18e") != std::string::npos){
  ...
  if(runPeriod.find("LHC18f") != std::string::npos){
  ...
  if(runPeriod.find("LHC18l") != std::string::npos){
  ...
  if(runPeriod.find("LHC18m") != std::string::npos){
  ...
  if(runPeriod.find("LHC18o") != std::string::npos){
  ...
  if(runPeriod.find("LHC18p") != std::string::npos){
  ...
  plugin->SetAnalysisSource("AliAnalysisTaskAODTrackPairUtils.cxx AliAnalysisTaskAODEventStudy.cxx AliAnalysisTaskAODEventStudy.cxx");
  plugin->SetAdditionalLibs("libSTEERBase.so libESD.so libAOD.so libANALYSIS.so libANALYSISalice.so libANALYSISaliceBase.so libCORRFW.so libOADB.so libCore.so libTree.so libGeom.so libVMC.so libPhysics.so "
			    "AliAnalysisTaskAODTrackPairUtils.h AliAnalysisTaskAODTrackPairUtils.cxx AliAnalysisTaskAODEventStudy.h AliAnalysisTaskAODEventStudy.cxx AliAnalysisTaskAODEventStudy.h AliAnalysisTaskAODEventStudy.cxx");
