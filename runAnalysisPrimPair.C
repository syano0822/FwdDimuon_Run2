			 ...
			 bool isMix        = false)
{
  ...
  AliAnalysisTaskAODTrackPair *task
    ...
    (gInterpreter->ExecuteMacro(Form("AddTaskAODTrackPair.C(%u, %f, %f, %d, %f, %f, %f, %f, %f, %f, %f, %f, \"%s\", \"%s\",%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d,%d,%f,%d,%d,%d,%d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,\"%s\",%f,%f,%f,%d,%d,%d,%d)",
				     offlineTriggerMask,
				     min_vtxz,
				     max_vtxz,
				     min_vtx_cont,
